...
<table class="center">
    ...
    <tr>
        <td style="background-image:url(../view/Farmer.jpg);background-repeat: no-repeat;" height=400 width=400><a href=""><h1 style="color:white;font-size:90px;"><br><br><br>Farmer</h1></a> </td>
